...
import "package:clean_architecture/features/show_news/presentation/pages/components/news_card.dart";
            ...
            children: [
              const TextField(
                ...
                decoration: InputDecoration(
                    prefixIcon:
                        Icon(Icons.search, size: 20, color: Palette.lightGrey),
                    hintText: 'Search',
                    hintStyle:
                        TextStyle(color: Palette.lightGrey, fontSize: 14),
